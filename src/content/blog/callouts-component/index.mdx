...
description: 'v1.5.0 adds a configurable `<Callout>` component with note, theorem, proof, exercise, and other content-first variants.'
date: 2025-04-24
tags: ['v1.5.0']
image: './banner.png'
...
## v1.5.0 ships a real callout component

v1.5.0 adds the first content-focused component in astro-erudite: `<Callout>{:astro}`.

I was hesitant about adding it because the whole template was meant to stay minimal. The thing that changed my mind was seeing a real use case for it. User [@rezaarezvan](https://github.com/rezaarezvan) sent in a PR to add [rezaarezvan.com](https://rezaarezvan.com) to the README examples, and their site made the gap obvious: years of dense academic notes needed blocks for definitions, theorems, proofs, and exercises.

That was concrete enough to justify shipping the component:
