...
description: 'A personal write-up of how my team and I built EcoCart for LifeHack 2023, why it worked, and what I took away from it.'
date: 2023-05-30
...
I still like this project because it felt like one of those rare hackathon weekends where the idea, the build, and the demo all clicked at the same time.

When I look back at LifeHack 2023, I do not mainly remember the prize money or the photo at the end. I remember how clear the idea felt once we found it. A lot of hackathon projects start wide and slowly become more complicated. EcoCart was the opposite. Once we landed on the core idea, most of our decisions got simpler.

We wanted to build something that could make the environmental cost of online shopping visible while someone was still in the middle of deciding what to buy. That became **EcoCart**, a sustainable shopping companion with two parts:
...
The project ended up winning **LifeHack 2023** and the **SGID Award**, but what stayed with me was how much the project taught me about product timing. It is one thing to build a useful feature. It is another to make it show up at the exact moment it can still change a decision.
