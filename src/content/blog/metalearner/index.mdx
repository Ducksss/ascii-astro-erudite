...
That is the cleanest way I know to introduce my MetaLearner internship now.

Not because the internship can be reduced to four numbers, but because those numbers make the real shape of the work harder to flatten into "a few scattered tasks." The more I look back through the handoff site, the repo, the chart demo, and the redesign file, the clearer the throughline becomes: I was working on the layer between technical capability and actual product adoption.
...
I did not want to compress MetaLearner into one neat retrospective and accidentally sand away the parts that make it credible. The archive already has a strong pattern for this in [`mobile-nav-and-subposts`](/blog/mobile-nav-and-subposts): a parent post that frames the work, then subposts that go deeper where the work actually deserves depth.

MetaLearner had enough substance to need the same treatment.

### 1. [Building self-serve onboarding inside MetaLearner](/blog/metalearner/onboarding)

This covers the guided onboarding flow, the User Guide, prompt-writing support, and why I think first-time-user clarity was the highest-ROI problem in the internship.

### 2. [Making MetaLearner charts easier to inspect](/blog/metalearner/charts)

This covers the `/graphs/*` gallery, the interaction layer around zoom and hover inspection, and the responsive frontend work that made the data experience hold up better across devices.

### 3. [Using Figma to explore a clearer MetaLearner frontend](/blog/metalearner/redesign)

This covers the redesign file, responsive explorations, chart direction, and the developing design system around components, typography, colours, primitives, and icons.

### 4. [Prototyping real-time ideas and leaving a usable handoff](/blog/metalearner/handoff)

This covers the Socket.IO research repo, the handoff site, the future-only search references, and why I think a clean handoff is one of the last real deliverables of an internship.
