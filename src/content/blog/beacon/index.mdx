...
description: 'How I turned messy RC committee forwarding into a believable Telegram dashboard and bot workflow in about an hour.'
date: 2026-03-29
...
## One hour, one workflow

I only had about an hour to put Beacon together, so the product had to click in one sentence: Residential College committees were still forwarding the same update into multiple house chats manually.
...
This was not one of those comfortable "let's explore a few ideas and polish the edges later" builds. I was looking at the clock, locking onto one workflow that felt real, and deciding that every feature had to earn its place immediately. If it did not make the demo more believable, it did not make the cut.
...
Beacon was a team submission, not a solo project. I worked on Beacon together with **Yu Hoe Tan** and **Esther Toh**.
