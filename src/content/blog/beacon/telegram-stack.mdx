...
description: 'The practical architecture behind Beacon: dashboard, Telegram bot flow, webhook handling, poll collation, and Supabase-backed state.'
date: 2026-03-29
...
## The Stack Had To Be Simple

Because Beacon came together in about an hour, I was not trying to design the perfect architecture. I was trying to design an architecture with good enough edges that the product story would hold. In hackathons, I have very little patience for stack maximalism when the product loop is still fuzzy.
