...
description: 'Why this elderly-care hackathon build stayed with me, what I learned building the backend in Node, and why the product philosophy mattered more than the AI.'
date: 2026-04-02
...
SafeStep was one of those hackathon projects that stayed in my head after the deadline ended. Not because the stack was especially flashy, but because the product question underneath it was genuinely hard.

The public submission called it **SafeStep**. The repo and PRD later called it **AgeWell**. The name changed, but the core idea did not: build an elderly-care system that reduces caregiver anxiety without turning the care recipient into someone who feels watched all day.

I like that tension a lot. It is easy to build something that is technically capable and emotionally clumsy. It is much harder to build something useful that still preserves dignity.
...
This was submitted together with **Anton Ang**, **Ivan Chua**, and **Faith Lee**, and I think the best part of the project was that the feature set actually served one coherent idea instead of feeling like a pile of hackathon tricks.
