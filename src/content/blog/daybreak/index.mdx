...
description: 'Revisiting an early Android meditation app, the research behind it, and what it taught me about building products that feel calmer than the problem they solve.'
date: 2026-04-01
...
Daybreak was one of the first projects where I tried to build around a feeling instead of a feature list.

On paper, it was a meditation app. In practice, the real problem was attention. Too many people already felt mentally scattered, and a lot of the apps in this space felt contradictory to their own pitch. They promised calm, then overwhelmed the user with noise.

That tension is probably why I still like this project. Even that early, I was already asking a question that keeps showing up in my work: if a product says it wants to lower mental load, does the product itself actually behave that way?
